        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Add a User</h1>
                    <p class="mb-4">Fill in the fields to add a new user.</p>
			...
			<form action="" id="manage_user">
				...
				<div class="col-lg-12 text-right justify-content-center d-flex">
					...
					<button class="btn btn-secondary" type="button" onclick="location.href = 'user_list.php?page=user_list'">Cancel</button>
				</div>
			</form>
