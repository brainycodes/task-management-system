        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">Add or remove content from this project.</p>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 d-flex ">
                            <h6 class="m-0 font-weight-bold text-primary">Edit this Project</h6>
                        </div>
                        <div class="card-body">
                        <div class="col-lg-12">
          	...
          	<div class="col-md-6">
				<div class="form-group">
					...
					<select name="status" id="status" class="custom-select custom-select-sm">
						...
						<option value="1" <?php echo isset($status) && $status == 2 ? 'selected' : '' ?>>Started</option>
      ...
      <?php endif; ?>
    	...
    	<div class="card-footer border-top border-info">
    		<div class="d-flex w-100 justify-content-center align-items-center">
    			<button class="btn btn-primary  mx-2" form="manage-project">Update</button>
